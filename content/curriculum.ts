    ...
    chapters: [
      {
        ...
        units: [
          ...
          u("complement-transitive", "목적격보어와 자동사·타동사", "", ["고1", "고2"], true),
          u("parallel-inversion", "병렬·대동사·도치", "", ["고1", "고2"], true),
          u("tense-mood", "시제·가정법·조동사", "", ["고1", "고2"], true),
          u("practice", "실전 세트: 29번형 지문", "", ["고1", "고2"], true),
        ],
      },
    ],
  },
