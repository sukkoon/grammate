    ...
    chapters: [
      {
        ...
        units: [
          u("what-is-pos", "품사: 단어의 직업", "8품사를 한눈에. 품사를 알면 사전이 읽히고 문장이 보여요.", ["초등", "중1"], true),
          u("core-four", "문장의 주인공들: 명사·동사·형용사·부사", "이름, 움직임, 꾸밈. 문장의 대부분은 이 넷이 만들어요.", ["초등", "중1"], true),
          u("helpers", "잇고 대신하고 외치는 말: 대명사·전치사·접속사·감탄사", "나머지 넷의 품사와 관사까지.", ["초등", "중1"], true),
          u("one-word-many-jobs", "한 단어, 여러 직업", "like는 동사일까, 전치사일까? 품사는 자리가 정해요.", ["중1", "중2"], true),
        ],
      },
      {
        ...
        units: [
          u("five-roles", "문장 속 다섯 가지 역할", "품사는 직업, 성분은 오늘 맡은 역할.", ["중1", "중2"], true),
          u("forms-of-elements", "성분이 될 수 있는 여러 모양", "주어 자리에 to부정사, 동명사, 명사절이 올 수 있어요.", ["고1", "고2"], true),
        ],
      },
      {
        slug: "phrase-clause",
        ...
        units: [
          u("phrase-vs-clause", "구와 절의 차이", "동사가 있느냐 없느냐.", ["중2"], true),
          u("three-clauses", "명사절·형용사절·부사절", "절도 품사처럼 일해요.", ["중3", "고1"], true),
        ],
      },
      {
        slug: "verbs-basics",
      ...
      },
      {
        ...
        units: [
          u("five-patterns", "1~5형식 한눈에", "동사가 무엇을 필요로 하느냐가 형식을 정해요.", ["초등", "중1"], true),
          u("linking-verbs", "감각동사와 2형식", "look, sound, smell + 형용사", ["중1"], true),
          u("giving-verbs", "수여동사와 4형식", "give, send, show + 사람 + 물건", ["중1", "중2"], true),
          u("object-complements", "5형식과 목적격보어", "사역동사·지각동사까지", ["중2", "중3", "고1"], true),
        ],
      },
    ],
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        units: [
          u("adjectives", "형용사의 두 가지 자리", "명사 앞, 그리고 보어 자리", ["초등", "중1"], true),
          u("quantifiers", "수량형용사", "many, much, a few, a little", ["초등", "중1"], true),
          u("adverbs", "부사와 빈도부사", "-ly의 비밀과 always, usually", ["초등", "중1"], true),
          u("tricky-adverbs", "헷갈리는 형용사와 부사", "hard/hardly, late/lately", ["고1", "고2"], true),
        ],
      },
      {
        slug: "comparison",
        ...
        units: [
          u("forms", "비교급과 최상급 만들기", "-er, -est, more, most", ["초등", "중1"], true),
          u("as-as", "원급 비교", "as ~ as", ["중1", "중2"], true),
          u("comparative-expressions", "비교급을 이용한 표현", "배수사, the 비교급 the 비교급", ["중2", "중3"], true),
          u("superlative-meaning", "최상급을 나타내는 여러 방법", "No other ~ than", ["중3", "고1"], true),
        ],
      },
      {
        slug: "prepositions",
        ...
        units: [
          u("time", "시간의 전치사", "at, on, in", ["초등", "중1"], true),
          u("place", "장소와 방향의 전치사", "in, on, under, into, through", ["초등", "중1"], true),
          u("prep-vs-conj", "전치사 vs 접속사", "during vs while, because of vs because", ["고1", "고2"], true),
        ],
      },
    ],
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        units: [
          u("basic", "can, may, must, will, should", "", ["초등", "중1"], true),
          u("more", "had better, used to, would like to", "", ["중2"], true),
          u("guess", "추측의 조동사", "must be, can't be", ["중3"], true),
          u("have-pp", "조동사 + have p.p.", "과거에 대한 추측과 후회", ["중3", "고1"], true),
          u("special-should", "should의 특별한 쓰임과 대동사 do", "", ["고1", "고2"], true),
        ],
      },
      {
        slug: "passive",
        ...
        units: [
          u("basic", "수동태의 기본", "be + p.p.", ["중1", "중2"], true),
          u("tenses", "여러 시제의 수동태", "", ["중2", "중3"], true),
          u("patterns", "4·5형식의 수동태", "", ["중3", "고1"], true),
          u("phrasal", "구동사와 by 이외의 전치사", "", ["중3", "고1"], true),
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        units: [
          u("pronouns", "관계대명사 who, which, that", "", ["중2"], true),
          u("what", "관계대명사 what", "", ["중2", "중3"], true),
          u("adverbs", "관계부사", "where, when, why, how", ["중3"], true),
          u("advanced", "계속적 용법, 전치사 + 관계사, 복합관계사", "", ["고1", "고2"], true),
        ],
      },
    ],
  },
    ...
    chapters: [
      {
        ...
        units: [
          u("agreement", "수일치와 대명사 일치", "주어에 괄호를 쳐 진짜 주어를 찾고, 대명사는 가리키는 명사에 맞춰요.", ["고1", "고2"], true),
          u("verb-verbal", "동사 vs 준동사, 능동 vs 수동", "자리가 먼저, 태가 그다음. 진짜 동사인지 가리고 능동·수동을 정해요.", ["고1", "고2"], true),
          u("which-word", "that/what/관계부사, 형용사/부사, 전치사/접속사", "선행사와 뒤 절의 완전성, 보어 자리, 뒤에 오는 말로 헷갈리는 짝을 골라요.", ["고1", "고2"], true),
          u("complement-transitive", "목적격보어와 자동사·타동사", "동사가 고르는 목적격보어의 모양과, 목적어가 필요한 동사인지를 확인해요.", ["고1", "고2"], true),
          u("parallel-inversion", "병렬·대동사·도치", "짝의 모양을 맞추고, 대동사는 앞 동사에, 도치된 동사는 뒤의 주어에 맞춰요.", ["고1", "고2"], true),
          u("tense-mood", "시제·가정법·조동사", "시간 단서로 시제를 정하고, 가정법의 짝과 조동사 have p.p.의 뜻을 가려요.", ["고1", "고2"], true),
          u("practice", "실전 세트: 29번형 지문", "지문 하나에서 밑줄 다섯 개를 점검표로 차례차례 확인해요.", ["고1", "고2"], true),
        ],
      },
    ],
  },
