...
export default function PrivacyPage() {
  return (
    <div className="lesson mx-auto max-w-3xl px-4 pb-10 pt-10 sm:px-6">
      ...
      <h2>1. 지금 모으는 정보</h2>
      <p>
        그래머랑은 지금 회원가입 없이 쓸 수 있고, 서버에 개인정보를 모으지 않아요. 단어장, 확인 문제 기록, 읽은 단원은 이용자의
      ...
      <p>
        ...
        브라우저 회사(예: Google, Apple)의 서버에서 글자로 바뀔 수 있어요. 그래머랑은 음성 파일을 저장하지 않아요. 읽어 주기에 AI 음성을
        쓸 때는 읽을 문장(예문·답)만 음성 합성 서비스(예: OpenAI, Microsoft)로 보내고, 이름·전화번호 같은 이용자 정보는 보내지 않아요.
      </p>
