...
export default function TosPage() {
  return (
    <div className="lesson mx-auto max-w-3xl px-4 pb-10 pt-10 sm:px-6">
      <h1 className="text-[2rem] font-extrabold">이용약관</h1>
      <p className="text-ink-3">초안 · 정식 서비스 전에 내용을 확정할 예정이에요.</p>

      <h2>1. 서비스</h2>
      <p>그래메이트는 초등 고학년부터 고등학생까지를 위한 영어 문법 학습 서비스예요. 지금은 누구나 무료로 쓸 수 있어요.</p>

      <h2>2. 콘텐츠</h2>
      <p>
        그래메이트의 설명, 예문, 그림, 문제는 그래메이트가 직접 만들었어요. 개인 공부를 위해 자유롭게 보고 쓸 수 있지만, 허락 없이
