...
export default function TosPage() {
  return (
    <div className="lesson mx-auto max-w-3xl px-4 pb-10 pt-10 sm:px-6">
      ...
      <h2>4. 읽어 주기 목소리</h2>
      <p>
        예문과 답을 읽어 주는 목소리는 사람이 녹음한 목소리가 아니라 컴퓨터가 만든 합성 음성이에요. 이용자의 브라우저에 들어 있는 음성을
        쓰거나, 설정에 따라 AI 음성 합성 서비스(예: OpenAI, Microsoft)로 만든 목소리를 써요. AI 음성이 처음 나올 때는 화면에도 따로
        알려 드려요.
      </p>
