...
const PC2_MEANINGS: { name: string; conj: string; en: string; ko: string }[] = [
  ...
  { name: "조건", conj: "if: ~하면", en: "[[Turning]] left, you will see the library.", ko: "왼쪽으로 돌면 도서관이 보일 거야." },
  { name: "양보", conj: "although: ~이지만", en: "[[Living]] next door, I rarely see her.", ko: "옆집에 살지만 그녀를 거의 못 봐." },
...
const PC2_FORMS: { key: string; time: string; rel: string; form: string; en: string; ko: string; tone: string }[] = [
  ...
  },
  {
    ...
    rel: "주어가 당한다",
    form: "(Being) p.p.",
    en: "[[Seen]] from the sky, the island looks like a heart.",
  ...
  },
  {
    ...
    rel: "주어가 한다",
    form: "Having p.p.",
    en: "[[Having finished]] my homework, I went out.",
    ko: "숙제를 끝내고 나서 나갔어.",
    tone: "bg-mint-soft text-mint-ink",
  },
  {
...
const PC2_BEFORE = { en: "[[Having finished]] my homework,", ko: "숙제를 끝냈어요" };
